	...
	return (
		<div className="mt-24">
			<div className="flex flex-wrap lg:flex-nowrap justify-center">
				<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-[linear-gradient(152deg,_#fff,_#00bfd8_42%,_#0083f5)]">
					<div className="flex justify-between items-center">
						<div>
							<p className="font-bold text-gray-400">Earnings</p>
							<p className="text-2xl">$77,123.91</p>
						</div>
					</div>
					<div className="mt-6">
				...
				<div className="flex m-3 flex-wrap justify-center gap-1 items-center">
					{earningData.map((item) => (
						<div key={item.title} className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-xl">
							...
							<p className="mt-3">
								<span className="text-xg font-semibold">{item.amount}</span>
				...
				<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-800">
					...
					<div className="mt-10 flex flex-wrap gap-10 justify-center">
						<div className="border-r-1 border-color m-4 pr-10">
							...
							<div className="mt-8">
								<p>
									<span className="text-3xl font-semibold">$56,128</span>
								</p>
